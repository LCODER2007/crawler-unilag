...
def main() -> int:
    print("Migration: adding special_collection_score + special_collection_categories to items")
    ...
    if not column_exists('items', 'special_collection_categories'):
        ...
        statements.append("ALTER TABLE items ADD COLUMN special_collection_categories TEXT")
    else:
