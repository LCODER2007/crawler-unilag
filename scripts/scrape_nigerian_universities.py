...
def generate_sample_names(institution: str, count: int) -> List[str]:
    ...
    yoruba_surnames = [
        "Adeyemi", "Ogunlana", "Oluwaseun", "Babatunde", "Adebayo", "Oladipo",
        "Adekunle", "Olatunji", "Adewale", "Olaniyan", "Afolabi", "Ogunbiyi",
        "Adeyinka", "Oladele", "Adebisi", "Ogunleye", "Adeola", "Olayinka"
    ]
    
    igbo_surnames = [
        "Okonkwo", "Nwosu", "Okeke", "Eze", "Okafor", "Nwankwo", "Chukwu",
        "Onyeka", "Ikechukwu", "Obiora", "Emeka", "Chinedu", "Ugochukwu",
        "Nnamdi", "Chibueze", "Obinna", "Kelechi", "Chukwuemeka"
    ]
    
    hausa_surnames = [
        "Ibrahim", "Mohammed", "Abdullahi", "Usman", "Ahmad", "Hassan",
        "Aliyu", "Musa", "Abubakar", "Suleiman", "Yusuf", "Ismail",
        "Bello", "Garba", "Sani", "Umar", "Tijjani", "Kabir"
    ]
    
    # Common first names
    first_names = [
        "Oluwaseun", "Chinedu", "Abubakar", "Ngozi", "Fatima", "Chiamaka",
        "Tunde", "Emeka", "Musa", "Adaeze", "Zainab", "Chioma",
        "Segun", "Obinna", "Aliyu", "Amaka", "Aisha", "Ifeoma"
    ]
